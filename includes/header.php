...
<html lang="id">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="https://fotogalery.wuaze.com/favicon_web.png" type="image/png">
  </head>
  <body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm">
      <div class="container">
        <a class="navbar-brand fw-semibold" href="<?= BASE_URL ?>/">Galeri Foto & Cerita</a>
